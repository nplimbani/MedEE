...
public class Admin_Pending_Request extends Fragment implements Admin_Pending_RviewAdpter.DeleteHospital {
    RecyclerView admin_pen_rv;
    Context context;
    ArrayList<Admin_item1> admin_hospital_first_list;
    Admin_Pending_RviewAdpter.DeleteHospital deleteHospital;
    String HOSPITAL_ID;
    SwipeRefreshLayout admn_sucess_swipeContainer1;


    @SuppressLint("ValidFragment")
    public Admin_Pending_Request(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        admin_pen_rv = (RecyclerView) view.findViewById(R.id.admin_pen_rv);
        deleteHospital = this;
        admn_sucess_swipeContainer1 = (SwipeRefreshLayout) view.findViewById(R.id.admn_sucess_swipeContainer1);

        CallAdminPendingApi();
        admn_sucess_swipeContainer1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    public void fetchTimelineAsync(int page) {
        ...
        CallAdminPendingApi();
        admn_sucess_swipeContainer1.setRefreshing(false);

    }

    public void CallAdminPendingApi() {
        // AppConstants.showDialog(context);
        RequestParams requestParams = new RequestParams();

        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        asyncHttpClient.post(context, URL.SIGNUP_ADMIN_FIRSTPAGE_LIST, requestParams, new AsyncHttpResponseHandler() {
            @Override
    ...
    public void CallAdpter() {
        ...
        Admin_Pending_RviewAdpter adapter = new Admin_Pending_RviewAdpter(context, admin_hospital_first_list, deleteHospital);
    ...
    public void deletedata(int position, String hospital_id) {
        ...
        //admin_hospital_first_list.remove(position);
        CallVerifyApi();

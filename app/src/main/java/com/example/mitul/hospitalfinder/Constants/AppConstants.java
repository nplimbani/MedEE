...
public class AppConstants {
    ...
    public static void openErrorDialog1(final Context context, String error_msg) {
        ...
        Button btn_done=(Button)dialog.findViewById(R.id.btn_done1) ;
        txt_error_msg.setText(error_msg);
        btn_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    /*    String EMAIL_STRING = "^[_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@"
       ...
       String EMAIL_STRING = "[a-zA-Z0-9._-]+@[a-z]+\\.com";

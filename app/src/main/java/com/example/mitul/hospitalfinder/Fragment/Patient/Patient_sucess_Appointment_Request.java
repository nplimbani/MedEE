...
public class Patient_sucess_Appointment_Request extends Fragment {
    RecyclerView pt_lg1_ap_suc_rv;
    TextView txt_pt_lg1_ap_suc_nofound;
    Context context;
    ArrayList<Patient_Appointment> patient_appointments_sucess_list;
    SwipeRefreshLayout pt_lg1_ap_suc_swipeContainer;


    String patient_id;
    String ORDERID,BLOOD_ID,STOCK,REASON;

    public Patient_sucess_Appointment_Request(Context context, String patient_id) {
        this.context = context;
        this.patient_id = patient_id;
    }
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.patient_sucess_appointment_request, container, false);
        pt_lg1_ap_suc_rv = (RecyclerView) view.findViewById(R.id.pt_lg1_ap_suc_rv);
        txt_pt_lg1_ap_suc_nofound=(TextView)view.findViewById(R.id.txt_pt_lg1_ap_suc_nofound);
        pt_lg1_ap_suc_swipeContainer = (SwipeRefreshLayout) view.findViewById(R.id.pt_lg1_ap_suc_swipeContainer);
        CallPatientAppointmentSucessRequstApi();
        pt_lg1_ap_suc_swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void CallAdpter() {
        ...
        Collections.sort(patient_appointments_sucess_list, new Comparator<Patient_Appointment>() {
            @Override
        ...
        pt_lg1_ap_suc_rv.setLayoutManager(layoutManager);
        Patient_Login1_Appointment_sucess_Adapter adapter = new Patient_Login1_Appointment_sucess_Adapter(context, patient_appointments_sucess_list);
        pt_lg1_ap_suc_rv.setAdapter(adapter);
    }
    ...
    public void fetchTimelineAsync(int page) {
        ...
        CallPatientAppointmentSucessRequstApi();
        pt_lg1_ap_suc_swipeContainer.setRefreshing(false);
    ...
    private void CallPatientAppointmentSucessRequstApi() {
        ...
        asyncHttpClient.post(context, URL.PATIENT_APPOINTMENT_SUCESS_REQUEST, requestParams, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if (status.equals("1")) {
                        ...
                        patient_appointments_sucess_list = new ArrayList<>();
                        if ((jsonArray.length()!=0)) {
                            txt_pt_lg1_ap_suc_nofound.setVisibility(View.GONE);
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                patient_appointments_sucess_list.add(patient_appointment);
                            }
                            CallAdpter();
                        }
                        else {
                            ...
                            txt_pt_lg1_ap_suc_nofound.setVisibility(View.VISIBLE);
